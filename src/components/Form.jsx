    ...
    return(
        <div className="w-full flex justify-center">
            ...
            onSubmit={submitFn}>
                ...
                <div className="inline-table space-x-4">
    ...
    return(
        <div className="w-full flex justify-center">
            ...
            onSubmit={submitFn}>
                ...
                <div className="inline-table space-x-4">
                <Input type="number" placeholder={"Carbohidratos"} change={changeCarb} icon={"apple.svg"} min="1" max="250"/>
                <a className="text-indigo-700 table-cell align-middle w-1/4" href="https://www.fatsecret.com.ar/Default.aspx?pa=recsh">Guia Alimentaria</a>
                </div>
                <Button btnType="submit" btnName="CALCULAR"/>
            </form>
        </div>
